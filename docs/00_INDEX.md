# HORMATHOS index — design HEXIS 3.1, V3-001, V3-002, V3-003

- [Active specification](01_MASTER_SPEC.md): authority and perimeter.
- [Decision Log](02_DECISION_LOG.md): adoption of 3.1 (V3-001), realignment of the repository with the publication act (V3-002), and the project name with the language rule (V3-003).
- [Full deposited plan](contracts/hexis-3.1/HEXIS_piano_definitivo_v3.1_2026-09-15.md) and [deposit identity](V3-001-deposit.json).
- [Roadmap](03_ROADMAP.md), [test inventory](TEST_INVENTORY.md), [handoff](HANDOFF.md) with the V5 statement of results and limitations.
