...
| `02_DECISION_LOG.md` | EN | 51 decisioni: D01–D31 con stato aggiornato, D32–D39 (v2) per esteso, **D40–D51 (v2.1, sincronizzazione con la proposta finale)** per esteso; open items O1–O8 (**O7 bloccante per G2/G5**); nodi differiti DN-1–DN-3 | Ogni volta che qualcosa deve cambiare: si emenda qui, mai in silenzio |
...
4. `02_DECISION_LOG.md`: leggi per esteso D32–D51; scorri le altre.
