...
L'attuale tranche **V0–V2 è completata**, con evidenze nell'[handoff](HANDOFF.md), senza nuovi fit reali. V2 è verificato su fixture sintetiche/analitiche; V3–V5 non attestati. La ripresa si ferma per revisione prima di V3. I fit iniziano soltanto in V3 dopo V0–V2. Il completamento del corpus è distinto dal completamento scientifico.
