...
| V2 | CTW, RNG/campione/shuffle, quattro perdite, diagnostiche, R1, resume | COMPLETATO — de8ea5d; ripresa e verifiche del 17 settembre nell'handoff |
...
Accettazione della ripresa V2: **240 test v31 senza skip; 561 passed e 17 skip
storici nella suite completa**, lock invariato. Collegamenti del core, selezione
del seme 0 e ripresa per coppia verificati soltanto su fixture. **Arresto per
revisione prima di V3**; il collegamento delle evidenze V2/V3 al manifest resta
parte dell'integrazione futura.
