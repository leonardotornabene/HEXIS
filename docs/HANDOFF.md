...
> `4766f355a0dfbf09ec70d7b07ba99b81d62e8e43`, working tree clean:**
>
> ```
...
> ```
>
> Re-attested 2026-09-02 after the post-review documentation pass (`eec419f`,
> `729679f`, `4766f35`): D55's two false `git.dirty: true` claims and its
> untracked-vs-ignored error corrected, the open-finding pointer added to
> `00`/`03`/`04`, and one overclaiming docstring in `sequences.py` corrected.
> **Every count is unchanged** — the pass touched prose only, no test and no
> library behaviour — and it is re-run rather than transcribed because a figure
> carried over untested is a figure nobody measured. Superseded attestation, same
> counts, kept for the trail: commit
