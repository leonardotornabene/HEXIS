...
6. **V4–V5**: campaign executed on 24 September 2026 and report on 25 September, in `results/hexis31/v3-seed0-v3006`. Open: the statement of results and limits (§14 V5, §16), the README after V5 (§17.2), and an act for the publication of the C0 position vectors if they are to be published (§17.3).

Stop for review before the statement of results.
